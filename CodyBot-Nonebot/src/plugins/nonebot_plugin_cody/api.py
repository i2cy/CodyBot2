...
if __name__ == '__main__':
    ...
    if USE_35:
        test_prompts = [
            ...
            {"role": "user", "content": "hello!", 'name': 'Icy'},
            {"role": "assistant", "content": "Hi Icy! It's so nice to see you! How are you doing today?", 'name': 'Cody'},
            {"role": "user", "content": "hello! who was that just talked to you my friend?", 'name': 'Miuto'},
        ]
        res, status = get_chat_response(key, test_prompts, ["Cody:"], use_35=True)
